...
**3.EU-CENTRAL-1 리전에서는 US-EAST-1이 요청한 정보가 Pending Acceptance 상태로 대기하며, Region을 관리하는 User가 Accept할 때까지 대기합니다.**
...
**4.\[그림 4.1.17\] "Action" 메뉴에서 "Accept" 하게 되면 아래와 같이 정상적으로 모든 리전에서 Peering 됩니다.**
...
![\[&#xADF8;&#xB9BC; 4.1.20 US-EAST-1 Transit Gateway Route Table\]](../.gitbook/assets/4.1.20.us-east-1-greenrt1.png)

6. US-EAST-1 리전에서 Transit Gateway Route Table - Green Route Table에 F OCTANK Attach를 Associate 이 정상적으로 수행되었는지 확인합니다.

\[US-EAST-1 Region\] - \[VPC\] - \[Transit Gateway\] - \[Transit Gateway Route Table\] - \[Green Route Table\]
