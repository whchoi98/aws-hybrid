...
</table>아래와 같이 TGW Route Table에서 Blackhole로 처리하고 각 EC2에서 트래픽 허용을 확인합니다.
...
![\[&#xADF8;&#xB9BC; 1.4.15 TGW Blue Route Table &#xD655;&#xC778;\]](../.gitbook/assets/1.4.15.blackhole_check.png)

![](../.gitbook/assets/1.4.16.blackhole_check.png)
